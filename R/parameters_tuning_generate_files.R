...
#save(mh_list1e4, file="data/mh_list1e4.Rdata") # CAUTIOUSLY! Not to overwrite!


# MH longer for reference
set.seed(1234)
mh_list1e5 <- get_list_of_log_values_MH(my_goal_function, max_iter = 100000, M = 10) # PC 2 h
#save(mh_list1e5, file="data/mh_list1e5.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(mc_list, file="data/mc_list.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(bg_start_id_list, file="data/bg_start_id_list.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(bg_start_random_list, file="data/bg_start_random_list.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(eo_list_out_1, file="data/eo_list_out_1.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(eo_list_out_2, file="data/eo_list_out_2.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(eo_list_out_3, file="data/eo_list_out_3.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(eo_list_out_4, file="data/eo_list_out_4.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(eo_list_out_5, file="data/eo_list_out_5.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(eo_list_out_6, file="data/eo_list_out_6.Rdata") # CAUTIOUSLY! Not to overwrite!
...
#save(eo_list_out_7, file="data/eo_list_out_7.Rdata") # CAUTIOUSLY! Not to overwrite!
